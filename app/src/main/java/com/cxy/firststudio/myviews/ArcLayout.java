...
public class ArcLayout extends ViewGroup {
    ...
    private static int computeRadius(final float arcDegrees, final int childCount, final int childSize,
        ...
        Log.d("chen", "computeRadius: arcDegrees="+arcDegrees+"childCount="+childCount+"childSize="+childSize+"childPadding="+childPadding+"minRadius="+minRadius);
        if (childCount < 2) {
            return minRadius;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d("chen", "onMeasure: radius="+radius);
        final int size = radius + mChildSize + mChildPadding + mLayoutPadding;
        Log.d("chen", "onMeasure: size="+size);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        final int centerX = getWidth()-mChildSize/2;
        final int centerY = getHeight()-mChildSize/2;
