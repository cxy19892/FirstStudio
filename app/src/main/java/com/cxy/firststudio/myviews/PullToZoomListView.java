...
public class PullToZoomListView extends ListView implements
    ...
    private void init(Context paramContext) {
        DisplayMetrics localDisplayMetrics = new DisplayMetrics();//获取分辨率
        ...
        setHeaderViewSize(i, (int) (9.0F * (i / 16.0F)));//设置headerview 的宽高
        ...
        addHeaderView(this.mHeaderContainer);//将header加入listview
